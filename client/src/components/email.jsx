...
// const SERVICE_ID = process.env.SERVICE_ID || process.env.REACT_APP_SERVICE_ID; 
// const TEMPLATE_ID = process.env.TEMPLATE_ID || process.env.REACT_APP_TEMPLATE_ID;
// const USER_ID = process.env.USER_ID || process.env.REACT_APP_USER_ID;

 function Email() {  
  //EMAIL PLACEHOLDER 
  return (
    <div>
      <h1 className="emailPlaceholder">Thank you for checking out my site.</h1>
      <h2 className="emailPlaceholder">To checkout my resume out, please click on the resume button link.</h2>
    </div>
  )
 }

  ///////////////////////////////////////////////////////////////////////////////
  ///// WORKING CODE FOR EMAIL.JS.
  ///CUT OUT BECAUSE COULDN'T SETUP EVIORMENT VARIABLES WITH VERCEL DUE TO BUILDING MY OWN BUILD FOLDER.
  ////////////////////////////////////////////////////////////////////////////////
